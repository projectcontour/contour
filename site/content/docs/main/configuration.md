...
# Troubleshooting
If you encounter issues, review the Troubleshooting section of [the docs][15], [file an issue][16], or talk to us on the [#contour channel][17] on the Kubernetes Slack server.
