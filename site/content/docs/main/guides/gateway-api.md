...
```shell
$ kubectl apply -f {{< param github_raw_url>}}/{{< param version >}}/examples/gateway/00-crds.yaml
```
...
```shell
$ kubectl apply -f {{< param github_raw_url>}}/{{< param version >}}/examples/example-workload/gatewayapi/kuard/kuard.yaml
```
This command creates:
