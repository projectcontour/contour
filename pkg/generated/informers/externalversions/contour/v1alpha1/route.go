...
import (
	...
	contour_v1alpha1 "github.com/heptio/contour/pkg/apis/contour/v1alpha1"
	versioned "github.com/heptio/contour/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/heptio/contour/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/heptio/contour/pkg/generated/listers/contour/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ContourV1alpha1().Routes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ContourV1alpha1().Routes(namespace).Watch(options)
			},
		},
		&contour_v1alpha1.Route{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&contour_v1alpha1.Route{}, f.defaultInformer)
}
