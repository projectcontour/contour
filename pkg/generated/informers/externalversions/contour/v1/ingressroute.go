...
import (
	...
	v1 "github.com/heptio/contour/pkg/generated/listers/contour/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.ContourV1().IngressRoutes(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ContourV1().IngressRoutes(namespace).Watch(options)
			},
		},
		&contour_v1.IngressRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ingressRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&contour_v1.IngressRoute{}, f.defaultInformer)
}
