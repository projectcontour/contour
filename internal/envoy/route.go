...
func RoutePrefix(prefix string, headers []dag.HeaderMatch) *envoy_api_v2_route.RouteMatch {
	return &envoy_api_v2_route.RouteMatch{
...
func headerMatcher(headers []dag.HeaderMatch) []*envoy_api_v2_route.HeaderMatcher {
