...
import (
	...
	envoy_tcpproxy_v3 "github.com/envoyproxy/go-control-plane/envoy/extensions/filters/network/tcp_proxy/v3"
...
func routeHostRewrite(cluster, newHostName string) *envoy_route_v3.Route_Route {
	return &envoy_route_v3.Route_Route{
		Route: &envoy_route_v3.RouteAction{
			...
			HostRewriteSpecifier: &envoy_route_v3.RouteAction_HostRewriteHeader{HostRewriteHeader: newHostName}, //(SAS) s/HostRewrite/HostRewriteHeader
		},
	}
}
...
func filterchaintlsfallback(fallbackSecret *v1.Secret, peerValidationContext *dag.PeerValidationContext, alpn ...string) *envoy_listener_v3.FilterChain {
	return envoy_v3.FilterChainTLSFallback(
		envoy_v3.DownstreamTLSContext(
			...
			envoy_tls_v3.TlsParameters_TLSv1_1,
			peerValidationContext,
			alpn...),
		envoy_v3.Filters(
...
func authzFilterFor(
	vhost string,
	authz *envoy_ext_auth_v3.ExtAuthz,
...
func tcpproxy(statPrefix, cluster string) *envoy_listener_v3.Filter {
	return &envoy_listener_v3.Filter{
		...
		ConfigType: &envoy_listener_v3.Filter_TypedConfig{
			TypedConfig: protobuf.MustMarshalAny(&envoy_tcpproxy_v3.TcpProxy{
