			...
			want: map[string]*v2.RouteConfiguration{
				"ingress_http": {
					...
					VirtualHosts: []route.VirtualHost{{
						...
						Domains: []string{"my-very-very-long-service-host-name.subdomain.boring-dept.my.company", "my-very-very-long-service-host-name.subdomain.boring-dept.my.company:*"},
						Routes: []route.Route{{
							Match:               envoy.PrefixMatch("/"),
