...
generator \
client-gen \
	--output-package ${CONTOUR}/apis/generated/clientset \
	--clientset-name versioned \
        --input-base "" \
	--input ${CONTOUR}/apis/contour/v1beta1,${CONTOUR}/apis/projectcontour/v1

generator \
lister-gen \
	--input-dirs ${CONTOUR}/apis/projectcontour/v1,${CONTOUR}/apis/contour/v1beta1 \
	--output-package ${CONTOUR}/apis/generated/listers

generator \
informer-gen \
	--input-dirs ${CONTOUR}/apis/projectcontour/v1,${CONTOUR}/apis/contour/v1beta1 \
	--versioned-clientset-package ${CONTOUR}/apis/generated/clientset/versioned \
	--listers-package ${CONTOUR}/apis/generated/listers \
	--output-package ${CONTOUR}/apis/generated/informers
