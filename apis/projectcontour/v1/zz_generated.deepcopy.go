...
func (in *AuthorizationProvider) DeepCopyInto(out *AuthorizationProvider) {
	*out = *in
	...
	if in.HTTPServerSettings != nil {
		...
		*out = new(PerRouteHTTPAuthorizationServerSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.Context != nil {
		in, out := &in.Context, &out.Context
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PerRouteHTTPAuthorizationServerSettings) DeepCopyInto(out *PerRouteHTTPAuthorizationServerSettings) {
	*out = *in
	if in.AllowedAuthorizationHeaders != nil {
		in, out := &in.AllowedAuthorizationHeaders, &out.AllowedAuthorizationHeaders
		*out = make([]HTTPAuthorizationServerAllowedHeaders, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PerRouteHTTPAuthorizationServerSettings.
func (in *PerRouteHTTPAuthorizationServerSettings) DeepCopy() *PerRouteHTTPAuthorizationServerSettings {
	if in == nil {
		return nil
	}
	out := new(PerRouteHTTPAuthorizationServerSettings)
...
func (in *Route) DeepCopyInto(out *Route) {
	*out = *in
	...
	if in.AuthPolicy != nil {
		in, out := &in.AuthPolicy, &out.AuthPolicy
		*out = new(RouteAuthorizationPolicy)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteAuthorizationPolicy) DeepCopyInto(out *RouteAuthorizationPolicy) {
	*out = *in
	if in.Context != nil {
		in, out := &in.Context, &out.Context
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteAuthorizationPolicy.
func (in *RouteAuthorizationPolicy) DeepCopy() *RouteAuthorizationPolicy {
	if in == nil {
		return nil
	}
	out := new(RouteAuthorizationPolicy)
...
func (in *VirtualHost) DeepCopyInto(out *VirtualHost) {
	*out = *in
	...
	if in.AuthzProviders != nil {
		in, out := &in.AuthzProviders, &out.AuthzProviders
