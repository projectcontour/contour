...
// ValidECDHCurves contains the set of ECDH curves that Envoy supports  via
// BoringSSL library. These names are passed directly to BoringSSL's
// SSL_CTX_set1_curves_list().
// For list of supported names, see kNamedGroups in:
// https://github.com/google/boringssl/blob/master/ssl/ssl_key_share.cc
