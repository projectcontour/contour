...
type HTTPProxyLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.HTTPProxy, err error)
...
// List lists all HTTPProxies in the indexer.
func (s *hTTPProxyLister) List(selector labels.Selector) (ret []*v1alpha1.HTTPProxy, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.HTTPProxy))
	})
	return ret, err
}
...
type HTTPProxyNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.HTTPProxy, error)
...
// List lists all HTTPProxies in the indexer for a given namespace.
func (s hTTPProxyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.HTTPProxy, err error) {
...
// Get retrieves the HTTPProxy from the indexer for a given namespace and name.
func (s hTTPProxyNamespaceLister) Get(name string) (*v1alpha1.HTTPProxy, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("httpproxy"), name)
	}
	return obj.(*v1alpha1.HTTPProxy), nil
}
