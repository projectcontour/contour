...
type TLSCertificateDelegationLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.TLSCertificateDelegation, err error)
...
// List lists all TLSCertificateDelegations in the indexer.
func (s *tLSCertificateDelegationLister) List(selector labels.Selector) (ret []*v1alpha1.TLSCertificateDelegation, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.TLSCertificateDelegation))
	})
	return ret, err
}
...
type TLSCertificateDelegationNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.TLSCertificateDelegation, error)
...
// List lists all TLSCertificateDelegations in the indexer for a given namespace.
func (s tLSCertificateDelegationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.TLSCertificateDelegation, err error) {
...
// Get retrieves the TLSCertificateDelegation from the indexer for a given namespace and name.
func (s tLSCertificateDelegationNamespaceLister) Get(name string) (*v1alpha1.TLSCertificateDelegation, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("tlscertificatedelegation"), name)
	}
	return obj.(*v1alpha1.TLSCertificateDelegation), nil
}
