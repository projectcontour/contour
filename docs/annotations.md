...
- `contour.heptio.com/upstream-tls` : [Use TLS when connecting upstream](https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/auth/cert.proto#envoy-api-msg-auth-upstreamtlscontext); defaults to false. Set to true to enable.
- `contour.heptio.com/upstream-tls-sni` : SNI string to use when creating upstream TLS connections. Requires `contour.heptio.com/upstream-tls`.
- `contour.heptio.com/upstream-tls-minimum-protocol-version` : Minimum TLS version upstream will accept. Valid values are `1.0`, `1.1`, `1.2`, and `1.3`.
- `contour.heptio.com/upstream-tls-maximum-protocol-version` : Maximum TLS version upstream will accept. Valid values are `1.0`, `1.1`, `1.2`, and `1.3`.
- `contour.heptio.com/upstream-tls-ciphersuites` : Cipher suites to use when connecting to upstream.
- `contour.heptio.com/upstream-tls-ecdh-curves` : EDCH Curves to use when connecting to upstream.
