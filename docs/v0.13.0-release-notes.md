...
Without the ability to configure the hash key, which is usually some form of session cookie, these strategies are not useful and cannot be used correctly.
